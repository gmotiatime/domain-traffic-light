            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="max-w-md space-y-4 rounded-3xl border border-white/10 bg-white/[0.02] p-8">
                  <div>
                    <label htmlFor="standardInput" className="mb-2 block text-sm font-medium">Стандартный инпут</label>
                    <input
                      id="standardInput"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="errorInput" className="mb-2 block text-sm font-medium text-white/50">С ошибкой</label>
                    <input
                      id="errorInput"
                      type="text"
