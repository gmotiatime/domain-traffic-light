        ...
        <div className="flex gap-2">
          {slides.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 ${i === currentSlide ? 'w-8 bg-emerald-500' : 'w-2 bg-white/20'}`}
            />
          ))}
        </div>
