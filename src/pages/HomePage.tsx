...
export function HomePage() {
  ...
  return (
    <div className="bg-background text-white selection:bg-white/20">
      ...
      <section className="relative isolate min-h-[90svh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[90svh] w-full max-w-7xl flex-col items-center justify-center px-4 pb-20 pt-32 text-center sm:px-6">
          <motion.div
            ...
            className="max-w-5xl"
          >
            <motion.p variants={fadeUp} className="text-xs font-medium uppercase tracking-[0.26em] text-white/50 sm:text-sm">
            ...
            <motion.div variants={fadeUp} className="mx-auto mt-12 w-full max-w-3xl">
              <form
                className="relative flex flex-col items-center gap-3 sm:flex-row sm:gap-2 rounded-[2rem] border border-white/10 bg-white/[0.04] p-3 backdrop-blur-2xl transition-all focus-within:border-white/20 focus-within:bg-white/[0.06] focus-within:shadow-[0_0_40px_rgba(255,255,255,0.05)]"
                onSubmit={(event) => {
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-2">
                ...
                <Button asChild className="h-10 px-0 text-sm text-white/50 hover:text-white hover:bg-transparent" variant="ghost">
      ...
      {/* ══════════ CTA SECTION ══════════ */}
      <section className="relative w-full bg-black py-20 pb-32">
